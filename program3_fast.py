...
BROKER = "localhost"
TOPIC = "sensors/cpu"
WINDOW_SIZE = 5  # Small window --> rapid reaction
...
def on_message(client, userdata, message):
    try:
        ...
        if cpu_val is not None and temp_val is not None:
            ...
            # 7. Print a message
            print(f"FAST : WINDOW SIZE: [{WINDOW_SIZE}] Load: {avg_value:.1f}% | Temp: {temp_val:.1f}°C | Status: {status}")
